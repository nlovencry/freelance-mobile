...
// import 'package:chatour/src/paket/view/paket_detail_haji_view.dart';
...
// class PaketHajiView extends StatefulWidget {
//   const PaketHajiView({super.key});

//   @override
//   State<PaketHajiView> createState() => _PaketHajiViewState();
// }

// class _PaketHajiViewState extends BaseState<PaketHajiView> {
//   List<String> kota_ = [
//     'Surabaya',
//     'Jember',
//     'Pasuruan',
...
//     await context.read<PaketProvider>().fetchPaketHaji();
...
//     final paketL = context.watch<PaketProvider>().paketHajiModel;
//     final cityDeparture =
...
//                     context,
//                     MaterialPageRoute(
//                         builder: (context) => PaketDetailHajiView(
...
//     return Scaffold(
//         appBar: header(), body: SingleChildScrollView(child: paketHajiList())
//         // ListView.separated(
//         //   physics: AlwaysScrollableScrollPhysics(),
//         //   shrinkWrap: true,
//         //   itemCount: 6,
//         //   itemBuilder: (context, index) => paketHajiList(),
//         //   separatorBuilder: (context, index) => SizedBox(),
//         // ),
//         );
//   }
