...
///
class AssetDowntimeModelDataCompany {
/*
{
  "id": 5,
  "name": "Regional 3",
...
*/
  ...
  AssetDowntimeModelDataCompany.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toString();
...
class AssetDowntimeModelDataRegional {
/*
{
  "id": 3,
  "code": "REG03",
...
*/
  ...
  AssetDowntimeModelDataRegional({
    this.id,
    this.code,
    this.name,
    this.description,
  ...
  AssetDowntimeModelDataRegional.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toString();
...
class AssetDowntimeModelDataJenisAsset {
/*
{
  "id": 10,
  "code": "A10",
...
*/
  ...
  AssetDowntimeModelDataJenisAsset({
    this.id,
    this.code,
    this.name,
    this.description,
  ...
  AssetDowntimeModelDataJenisAsset.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toString();
    code = json['code']?.toString();
    name = json['name']?.toString();
    description = json['description']?.toString();
...
class AssetDowntimeModelDataComponents {
/*
{
  "id": 17982,
  "subsystem_code": "SS1",
...
*/
  ...
  AssetDowntimeModelDataComponents({
    this.id,
    this.subsystemCode,
    this.assetCode,
    this.systemCode,
  ...
  AssetDowntimeModelDataComponents.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toString();
...
class AssetDowntimeModelDataCabang {
/*
{
  "id": 20,
  "regional_code": "REG03",
...
*/
  ...
  AssetDowntimeModelDataCabang.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toString();
...
*/
  ...
  String? downtime;
  String? exist;
  AssetDowntimeModelDataCabang? cabang;
  List<AssetDowntimeModelDataComponents?>? components;
  AssetDowntimeModelDataJenisAsset? jenisAsset;
  AssetDowntimeModelDataRegional? regional;
  AssetDowntimeModelDataCompany? company;
  List<String?>? file;
  String? approver;

  AssetDowntimeModelData({
    this.id,
    this.code,
    this.name,
    this.kapasitas,
  ...
  AssetDowntimeModelData.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toString();
    code = json['code']?.toString();
    name = json['name']?.toString();
    ...
    cabang = (json['cabang'] != null)
        ? AssetDowntimeModelDataCabang.fromJson(json['cabang'])
        : null;
    if (json['components'] != null) {
      final v = json['components'];
      final arr0 = <AssetDowntimeModelDataComponents>[];
      v.forEach((v) {
        arr0.add(AssetDowntimeModelDataComponents.fromJson(v));
      });
      components = arr0;
    }
    jenisAsset = (json['jenis_asset'] != null)
        ? AssetDowntimeModelDataJenisAsset.fromJson(json['jenis_asset'])
        : null;
    regional = (json['regional'] != null)
        ? AssetDowntimeModelDataRegional.fromJson(json['regional'])
        : null;
    company = (json['company'] != null)
        ? AssetDowntimeModelDataCompany.fromJson(json['company'])
        : null;
    // >>>>>>error<<<<<<
...
*/
  ...
  bool? success;
  List<AssetDowntimeModelData?>? data;
  String? page;
  String? length;
  String? message;
  ...
  AssetDowntimeModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      final v = json['data'];
      final arr0 = <AssetDowntimeModelData>[];
      v.forEach((v) {
        arr0.add(AssetDowntimeModelData.fromJson(v));
      });
      this.data = arr0;
    }
