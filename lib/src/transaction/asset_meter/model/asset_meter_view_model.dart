...
*/
  ...
  AssetMeterViewModelData.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toString();
...
*/
  ...
  bool? success;
  List<AssetMeterViewModelData?>? data;
  String? page;
  String? length;
  String? message;
  ...
  AssetMeterViewModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      final v = json['data'];
      final arr0 = <AssetMeterViewModelData>[];
      v.forEach((v) {
        arr0.add(AssetMeterViewModelData.fromJson(v));
      });
      this.data = arr0;
    }
