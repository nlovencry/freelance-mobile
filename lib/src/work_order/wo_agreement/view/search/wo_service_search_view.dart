...
class _WOServiceSearchViewState extends BaseState<WOServiceSearchView> {
  ...
  Widget build(BuildContext context) {
    final woServiceP = context.watch<WOAgreementProvider>();
    final pagingC = context.watch<WOAgreementProvider>().pWoServiceController;
    ...
    Widget search() => CustomTextField.borderTextField(
          ...
          onChange: (val) {
            if (woServiceP.searchOnStoppedTyping != null) {
              woServiceP.searchOnStoppedTyping!.cancel();
            }
            woServiceP.searchOnStoppedTyping = Timer(woServiceP.duration, () {
              pagingC.refresh();
            });
          },
        );
