...
class _WOSparepartSearchViewState extends BaseState<WOSparepartSearchView> {
  ...
  Widget build(BuildContext context) {
    final woSparepartP = context.watch<WOAgreementProvider>();
    final pagingC = context.watch<WOAgreementProvider>().pWoSparepartController;
    ...
    Widget search() => CustomTextField.borderTextField(
          ...
          onChange: (val) {
            if (woSparepartP.searchOnStoppedTyping != null) {
              woSparepartP.searchOnStoppedTyping!.cancel();
            }
            woSparepartP.searchOnStoppedTyping =
                Timer(woSparepartP.duration, () {
              pagingC.refresh();
            });
          },
        );
