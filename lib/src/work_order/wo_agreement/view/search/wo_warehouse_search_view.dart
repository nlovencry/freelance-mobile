...
class _WOWarehouseSearchViewState extends BaseState<WOWarehouseSearchView> {
  ...
  Widget build(BuildContext context) {
    final woWarehouseP = context.watch<WOAgreementProvider>();
    final pagingC = context.watch<WOAgreementProvider>().pWoWarehouseController;
    ...
    Widget search() => CustomTextField.borderTextField(
          ...
          onChange: (val) {
            if (woWarehouseP.searchOnStoppedTyping != null) {
              woWarehouseP.searchOnStoppedTyping!.cancel();
            }
            woWarehouseP.searchOnStoppedTyping =
                Timer(woWarehouseP.duration, () {
              pagingC.refresh();
            });
          },
        );
