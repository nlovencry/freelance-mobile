...
///
class DeleteWORealizationModelData {
/*
{
  "id": 7865,
...
*/
  ...
  DeleteWORealizationModelData.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toInt();
...
class DeleteWORealizationModel {
/*
{
  "success": true,
  "data": {
...
*/
  ...
  bool? success;
  DeleteWORealizationModelData? data;
  String? message;

  DeleteWORealizationModel({
    this.success,
    this.data,
    this.message,
  });
  DeleteWORealizationModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    data = (json['data'] != null) ? DeleteWORealizationModelData.fromJson(json['data']) : null;
