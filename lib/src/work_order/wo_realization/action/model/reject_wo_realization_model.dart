...
///
class RejectWORealizationModelData {
/*
{
  "id": 7865,
...
*/
  ...
  RejectWORealizationModelData.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toInt();
...
class RejectWORealizationModel {
/*
{
  "success": true,
  "data": {
...
*/
  ...
  bool? success;
  RejectWORealizationModelData? data;
  String? message;

  RejectWORealizationModel({
    this.success,
    this.data,
    this.message,
  });
  RejectWORealizationModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    data = (json['data'] != null) ? RejectWORealizationModelData.fromJson(json['data']) : null;
