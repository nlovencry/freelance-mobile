...
class AttachmentWORealization extends StatefulWidget {
  bool isEdit;
  AttachmentWORealization({super.key, this.isEdit = false});

  @override
  State<AttachmentWORealization> createState() =>
      _AttachmentWORealizationState();
}

class _AttachmentWORealizationState extends BaseState<AttachmentWORealization> {
  @override
  Widget build(BuildContext context) {
    final attachmentP = context.watch<WORealizationProvider>();
